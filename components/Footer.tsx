        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="text-[9px] text-primary-light/70 tracking-wider">대한예수교장로회(통합)</p>
                <h3 className="text-xl font-bold text-white font-serif">동탄구미교회</h3>
                <p className="text-[10px] text-brown-200/60 tracking-wider">DONGTANGUMEE CHURCH</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a href="https://www.youtube.com/@동탄구미교회" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-brown-700 hover:bg-primary rounded-full flex items-center justify-center transition-colors" aria-label="YouTube">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/dongtangumi" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-brown-700 hover:bg-primary rounded-full flex items-center justify-center transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link href="/pastor" className="text-brown-200/70 hover:text-primary transition-colors">담임목사</Link></li>
              ...
              <li><Link href="/mission" className="text-brown-200/70 hover:text-primary transition-colors">선교</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:msfide@hanmail.net" className="text-brown-200/70 hover:text-primary transition-colors">msfide@hanmail.net</a>
              </li>
            </ul>
          </div>
        </div>
